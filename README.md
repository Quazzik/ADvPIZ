...
В зоде выполнения этого задания мной был модифицирован код на Python, туда была добавлена функция линйной регрессии. Код представлен ниже:
...
В ходе выполнения этого задания я изменил сценарий обработки данных, извенил искомое значение на изменение инфляции и уже в соответствии с этим изменением воспроизводил звуки, новый фрагмент кода представлен ниже:
...
В ходе выполнения этой работы я поздакомился с API для работы Python и C# с гугл-таблицами, научился генерировать данные в питоне и передаваь их в C#. Изучил ранее неизвествую мне библиотеку SimpleJSON для C#, научился создавать и настраивать гугл-таблицы, лучше изучил библиотеку numpy для питона. Так же я создал первый проект в Unity, состоящий не только из скрипта, выводящего одно сообщение при запуске, а обрабатывающий данные каждый условный тик и воспроизводящий звук.
